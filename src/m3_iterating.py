...
def run_test_count_negatives():
    ...
    #Test 6
    expected = 4
    actual = count_negatives([-8, -13, 7, -5, 0, 0,0,4,4,4,3,3,-7])
    print()
    ...
    #Test 7
    expected = 3
    actual = count_negatives([-7, 1643643, 7, -5, -53, 0, -0])
    print()
...
def run_test_count_short_ones():
    ...
    #Test 8
    expected = 3
    seq = [[3,3,3,3], [1,1,1,1,1,1,1,1,11,1],[],[], []]
    actual = count_short_ones(seq)
    print()
    ...
    #Test 9
    expected = 4
    seq = [{1,1,1,1},[3,2], {3,2}, {3}, 'holaa', 'the']
    actual = count_short_ones(seq)
    print()
