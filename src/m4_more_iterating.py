...
def run_test_count_items_bigger_than():
    ...
    #Test 9
    expected = 6
    actual = count_items_bigger_than([4,11,24,78,42,724,52,6,32,46,426], 32)
    print('Test 9 expected:', expected)
    print('        actual: ', actual)

    #Test 10
    expected = 6
    actual = count_items_bigger_than([4, -11, -24, 78, 42, -724, 52, 6, -32, 46, -426,0,-0], 0)
...
def run_test_sum_first_n():
    ...
    #Test 9
    sequence = [ -100, 101, -102, 103, 0, 10000000,-99999999,0,1]
    expected = 2
    actual = sum_first_n(sequence, 4)
    print()
    print('Test 9 expected:', expected)
    print('         actual:', actual)
